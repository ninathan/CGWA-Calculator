    ...
    <header className="sticky top-0 z-50 bg-white/60 backdrop-blur-md border-b border-gray-200">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 text-gray-900">
          <div className="h-9 w-9 rounded-lg bg-indigo-600 flex items-center justify-center text-white font-bold">C</div>
          <div className="text-lg font-semibold">CGWA <span className="text-indigo-600">Calculator</span></div>
        </Link>
